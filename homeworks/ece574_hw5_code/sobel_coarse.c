...
int main(int argc, char **argv) {
	...
	// Get the time it takes to do the convolution
	start = PAPI_get_real_usec();

// Tell OMP that im going to make sections
#pragma omp parallel sections
{
// Make a section for sobel x
#pragma omp section
{
...
#pragma omp section 
{
	...
	stop = PAPI_get_real_usec();
	result = stop - start;
	printf("Convolution Time: %llds\n", result);

	// Get the time it takes to do the combine
	start = PAPI_get_real_usec();
